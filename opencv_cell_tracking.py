...
def main():
    ...
    cell_with_templates = dict()
    cell_with_templates['1'] = 586.0, 770.0, cell_width, cell_height
    cell_with_templates['2'] = 452.0, 585.0, cell_width, cell_height
    cell_with_templates['10'] = 721.0, 779.0, cell_width, cell_height
    cell_with_templates['20'] = 1255.0, 475.0, cell_width, cell_height
    cell_with_templates['30'] = 1166.0, 447.0, cell_width, cell_height
    cell_with_templates['40'] = 1621.0, 963.0, cell_width, cell_height

    # processing sequences
    for sequence_name in sequences.keys():
        sequence = sequences[sequence_name]
        track(sequence_directory=sequence, tracker_names=tracker_names,
              instance_with_templates=cell_with_templates, image_extension=image_extension,
